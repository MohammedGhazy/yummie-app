...
//    func register(username: String ,email:String, password: String ,q:Int ,a: String , active:Int ,complation: @escaping(Result<User,Error>) -> Void) {
//
//        let params = [
//            "username": username,
//            "email": email,
...
//        ] as [String : Any]
//
//        request(route: .register, method: .post, parameters: params, completion: complation)
//    }
